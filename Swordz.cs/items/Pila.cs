...
namespace Vintagestory.GameContent
{
    ...
    public class Pila : Item
    {
        ...
        public override void OnHeldInteractStop(float secondsUsed, ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel)
        {
            ...
            EntityProperties type = byEntity.World.GetEntityType(new AssetLocation(Attributes["pilaEntityCode"].AsString()));
            ...
            enpr.DropOnImpactChance = 1 - breakChance;
            enpr.Weight = 0.3f;
            ...
            if (byEntity is EntityPlayer) RefillSlotIfEmpty(slot, byEntity, (itemstack) => itemstack.Collectible is Pila);
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            //  This is for display purposes in gui on hover
