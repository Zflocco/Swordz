...
{
    public class ItemMithrilBloom : Item, IAnvilWorkable
    {
        ...
        public override string GetHeldItemName(ItemStack itemStack)
        {
            ...
            {
                return Lang.Get("Partially worked mithril bloom");
            }
        ...
        public ItemStack TryPlaceOn(ItemStack stack, BlockEntityAnvil beAnvil)
        {
            ...
            if (stack.Attributes.HasAttribute("voxels"))
            {
                ...
                {
                    CreateVoxelsFromMithrilBloom(ref beAnvil.Voxels);
                }
            }
            else
            {
        ...
        private void CreateVoxelsFromMithrilBloom(ref byte[,,] voxels)
        {
